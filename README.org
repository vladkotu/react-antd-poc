...
***** [C] Create account
  ...
  #+end_src
   ...
   #+begin_example json
   {
     "id": "6be54070-6e8a-11ea-966f-79ee4efae916",
     "createdDateTime": 1585135138295,
     "accType": "bookkeeping",
     "accNo": 111,
     "category": "Purchase",
     "vatPercent": 11,
...
****** Invalid request
  ...
  Date: Wed, 25 Mar 2020 11:19:14 GMT
...
***** [R2] Get single account  
    ...
    #+begin_src sh :results verbatim :exports both
      curl -vsi "${API}/accounts/d83f41e0-6d35-11ea-9d77-3dffd7d18939/?createdDateTime=1551172226477&pretty"
   #+end_src
   ...
   Content-Type: application/json; charset=utf-8
   Content-Length: 839
   ETag: W/"347-8UwvaUyL8Z9gwUbvp+bJFXGOfH4"
   Date: Wed, 25 Mar 2020 11:58:23 GMT
   Connection: keep-alive
   
   {
     ...
     "id": "d83f41e0-6d35-11ea-9d77-3dffd7d18939",
     "category": "Purchase",
     "accType": "bookkeeping",
     "vatPercent": 22
   }
...
***** [U] Update account
   #+NAME: update-account 
   #+begin_src sh :results verbatim :exports both
     curl -X PUT -vs "${API}/accounts/d83ef3c0-6d35-11ea-9d77-3dffd7d18939/?pretty" \
          -H 'Content-Type: application/json' \
          -d '{ "createdDateTime": "1446960934025","vatPercent": 111, "accName": "One One One" }'
  #+end_src
...
***** [D] Delete account
   #+NAME: delete-account 
   #+begin_src sh :results verbatim :exports both
     curl -X DELETE -vs "${API}/accounts/d83ef3c0-6d35-11ea-9d77-3dffd7d18939/?createdDateTime=1446960934025&pretty"
  #+end_src
