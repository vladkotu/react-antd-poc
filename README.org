...
***** [R2] Get single account  
    ...
    #+begin_src sh :results verbatim :exports both
      curl -vsi "${API}/accounts/d83ef3c0-6d35-11ea-9d77-3dffd7d18939/?createdDateTime=1446960934025&pretty"
   #+end_src
   ...
   Content-Type: application/json; charset=utf-8
   Content-Length: 277
   ETag: W/"115-/l/C3cVYzB5nSZ4KrfOAEKDAftc"
   Date: Wed, 25 Mar 2020 11:19:46 GMT
   Connection: keep-alive
