...
****** Create accounts table
    ...
    #+begin_src sh :results value code :eval never-export :exports code
      aws dynamodb create-table --generate-cli-skeleton > ./server/db/table-shema-example.json
    #+end_src

    #+NAME: delete-accounts-table
    #+begin_src sh :results silent :eval never-export :exports code
    ...
    #+NAME: create-table
    #+begin_src sh :results value org :eval never-export :exports code
     aws --endpoint-url http://localhost:4569 \
...
@@html:</details>@@
    ...
    #+RESULTS: create-table
   #+begin_src sh :results value code :eval never-export :exports code :post attr_wrap(width="5cm")
     aws --endpoint-url http://localhost:4569 \
...
***** [C] Create account
   #+NAME: create-account 
   #+begin_src sh :results value code :exports code :eval never-export
...
***** [R2] Get single account  
    ...
    #+begin_src sh :results value code :exports code
